...
public final class EarlyProvider extends ContentProvider {
 public boolean onCreate(){ Evidence.record(requireContext(),"provider"); return true; }
 private Context requireContext(){ return java.util.Objects.requireNonNull(getContext()); }
